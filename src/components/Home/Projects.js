...
export default function Projects() {
    return (
        <Wrapper>
            ...
            <ProjectsWrap>
                <ProjectCard title="Workout Tracker" url="/workout-tracker-screenshot.png" description="An app that helps users log exercises and track workout progress. Currently in development." stack="Next.JS, Express, MySQL" />
